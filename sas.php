	...
	<div class="frm radius">
		...
		unset($alerte); ?>
			...
			if (!isset($_SESSION['captcha']))
				...
				{
					echo '<p><img src='.$_SESSION['chemin_vers_fic_image'].$_SESSION['fic_image'].' alt="image captcha"/><br />';
				?>
...
?>
			<div class="col-contenu" >
				<div class="frm radius">
					...
					{
						echo '<img src='.$_SESSION['chemin_vers_fic_image'].$_SESSION['fic_image'].' alt="image captcha"/><br />';
					?>
					<label for="code">Recopier les caractères</label><br />
...
<div class="contenu_liens">
	<p style="text-align:center;"><a href="./account/mdp_oubli.php">Mot de passe oublié</a>&emsp;
			<a href="sas.php?nouveaumembre=1">Inscription</a>
	</p>
</div>
