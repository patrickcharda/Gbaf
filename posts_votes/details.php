		...
		if (isset($bdd))
		{
			...
			if (!is_null($reponse))
			{
				while ($data = $reponse->fetch())
				{
					...
					echo '<p><img src=./../logos/'.$data['logo'].'200x100.png alt="logo moyen"/></p><br />';
					echo '<p class="aacteur"><strong><a href=\'./../espacemembres.php\' >&larr;</a></strong></p><br />';
					echo '<div class="details_acteur"><h2>'.$data['acteur'].'</h2>';
					echo '<p>'.nl2br(htmlspecialchars($data['description'])).'</p></div>';
				}			
				$reponse->closeCursor();
			}
